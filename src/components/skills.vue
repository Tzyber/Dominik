...
const ICONS: Record<string, string> = {
  ...
  npm: '<svg class="logo" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"><rect width="256" height="256" fill="#CB3837" rx="12"/><path fill="#fff" d="M48 80h160v96h-80v16H80v-16H48zm16 16v64h16V112h16v48h16V96H64zm88 0v64h16v-16h16v16h16V96h-64z"/></svg>',
  vuetify: '<svg class="logo" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"><path fill="#7C8CFF" d="M128 24l96 40-48 168h-32l-64-160z" opacity=".85"/><path fill="#41B0F5" d="M128 24l-96 40 48 168h48z"/></svg>',
...
const skills = [
  ...
  { name: 'Vuetify', icon: ICONS.vuetify },
...
/* sci-fi corner brackets, revealed on hover — framing the icon, never hiding it */
.corner {
  position: absolute;
  width: 11px;
  height: 11px;
